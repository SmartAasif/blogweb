                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                <div class="form-group">
                                    <label for="projectname">Post Name</label>
                                    <input type="text" name="name" id="projectname" class="form-control" placeholder="Enter project name">
                                </div>

                                <div class="form-group">
                                    <label for="projectname">User Id</label>
                                    <input type="text" id="projectname" name="userId" class="form-control" placeholder="Enter project name">
                                </div>

                                <div class="form-group">
                                    <label for="project-overview">Post Content</label>
                                    <textarea class="form-control" name="content" id="project-overview" rows="5" placeholder="Enter some brief about project.."></textarea>
                                </div>
